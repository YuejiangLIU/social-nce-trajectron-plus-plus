...
class Trajectron(object):
    ...
    def set_environment(self, env, snce=None):
        self.env = env
    ...
    def train_loss(self, batch, node_type):
        (first_history_index,
         ...
         robot_traj_st_t,
         map, x_next_t, neighbors_prev_t, neighbors_next_t, safe_t) = batch
        ...
        loss, loss_task, loss_nce = model.train_loss(inputs=x,
                                inputs_st=x_st_t,
    ...
    def predict(self,
        ...
        for node_type in self.env.NodeType:
            ...
            (first_history_index,
             ...
             neighbors_edge_value,
             robot_traj_st_t,
             map, x_next_t, neighbors_prev_t, neighbors_next_t, safe_t), nodes, timesteps_o = batch
